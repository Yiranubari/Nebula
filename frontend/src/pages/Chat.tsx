...
const Chat = () => {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-3.5rem)] md:h-screen overflow-hidden bg-transparent">
      ...
      <div className="relative z-40 h-16 flex items-center justify-between px-6 bg-white/70 dark:bg-white/[0.03] backdrop-blur-xl shrink-0 shadow-[0_1px_0_rgba(15,23,42,0.04)] dark:shadow-[0_1px_0_rgba(255,255,255,0.03)]">
        <div className="flex items-center gap-2">
